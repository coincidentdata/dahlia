...
internal sealed class CoincidentMateHandler : MateHandler {
    protected override string WireType => "MateCoincident";
    protected override swMateType_e NativeType => swMateType_e.swMateCOINCIDENT;
    ...
    protected override void Apply(File file, object data, JsonNode input, bool creating) {
        var mate = (ICoincidentMateFeatureData)data;
